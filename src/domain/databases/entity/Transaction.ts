...
@Entity('transactions')
 class Transaction extends BaseEntity implements ITransaction {
  ...
  @Column(PostgresDataType.uuid, {comment: 'This is the subscription id'})
  ...
  @CreateDateColumn({ type: PostgresDataType.timestamp_without_timezone, comment: 'This is the timestamp of the transaction'})
    timestamp!: Date;
