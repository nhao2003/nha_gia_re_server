export const APP_MESSAGES = {
  ...
  Forbiden: 'You are not authorized to perform this action',
  ...
  PASSWORD_LENGTH_MUST_BE_AT_LEAST_8_CHARS_AND_LESS_THAN_32_CHARS:
    'Password length must be at least 8 chars and less than 32 chars',
  ...
  SUCCESS_MESSAGE: {
    ...
    YOUR_ACCOUNT_HAS_BEEN_SIGN_OUT_ON_ALL_DEVICES_YOU_CAN_CHANGE_PASSWORD_NOW:
      'Your account has been sign out on all devices, you can change password now',
